...
```{r}
grid.rf = expand.grid(num.trees = c(300, 400, 500), # c(200, 300, 400, 500),
                      mtry = c(3:5), # mtry = c(3:11)
...
mod.ridge.b.test$bestTune;mod.ridge.ub.test$bestTune
```

```{r}
pred.class.b.test = predict(mod.ridge.b,new=mydata.test)
pred.class.ub.test = predict(mod.ridge.ub,new=mydata.test)

cf.b.test = table(relevel(pred.class.b.test, ref="Malicious"), 
             relevel(mydata.test$Classification, ref="Malicious"))
cf.ub.test = table(relevel(pred.class.ub.test, ref="Malicious"),
             relevel(mydata.test$Classification, ref="Malicious"))

prop.b.test = round(prop.table(cf.b.test, 2), digits = 3);prop.b.test
prop.ub.test = round(prop.table(cf.ub.test, 2), digits = 3);prop.ub.test
