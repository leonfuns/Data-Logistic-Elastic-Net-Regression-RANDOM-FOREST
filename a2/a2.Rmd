...
rf.train = function(data.train) {
  for (I in 1:nrow(grid.rf)) {
    ...
    grid.rf$accuracy[I] = test.cf$byClass["Balanced Accuracy"]
...
confusion.matrix = function(train.rf){
  cm.vec = c(train.rf[1,12],train.rf[1,13],train.rf[1,14],train.rf[1,15])
...
train.rf.b$new.fp = train.rf.b$fn
train.rf.b$fn = train.rf.b$fp
train.rf.b$fp = train.rf.b$new.fp
train.rf.b = train.rf.b[-16]

train.rf.ub.t$new.fp = train.rf.ub.t$fn
train.rf.ub.t$fn = train.rf.ub.t$fp
train.rf.ub.t$fp = train.rf.ub.t$new.fp
train.rf.ub.t = train.rf.ub.t[-16]
